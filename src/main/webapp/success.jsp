		...
		<div>
			<table border="1">
				...
				try {
					...
					+ "from tbl_resv_202301 re, tbl_cust_202301 cu " + "where cu.cust_no = re.cust_no and cu.cust_no =? ";
					...
					while (rs.next()) {
						...
						String newresv_date = resv_date.substring(0, 4) + "년" + resv_date.substring(4, 6) + "월"
						+ resv_date.substring(6, 8) + "일";
				%>
				<tr>
